...
for model_i in z_pred:
    ...
    if model_i == 0:
        ...
        predictArray = KNN.test(X1_test[i:i + 1])
    ...
    if model_i == 1:
        # 查看是否和y对应位置匹配,X_test对应训练结果是X的位置，对应了y_test
        predictArray = decision_tree.test(X1_test[i:i + 1])
        predict = predictArray[0]
        # print("预测下标为 : \n", predict)
        # -fixme : get y_pred
        predict = correct(predict)
    ...
    if model_i == 2:
        # 查看是否和y对应位置匹配,X_test对应训练结果是X的位置，对应了y_test
        predictArray = rf.test(X1_test[i:i + 1])
        predict = predictArray[0]
        # print("预测下标为 : \n", predict)
        # -fixme : get y_pred
        predict = correct(predict)
    ...
    if model_i == 3:
        # 查看是否和y对应位置匹配,X_test对应训练结果是X的位置，对应了y_test
        predictArray = muti_reg.test(X1_test[i:i + 1])
        predict = predictArray[0]
        # print("预测下标为 : \n", predict)
        # -fixme : get y_pred
        predict = correct(predict)
    ...
    if model_i == 4:
        # 查看是否和y对应位置匹配,X_test对应训练结果是X的位置，对应了y_test
        predictArray = elastic_reg.test(X1_test[i:i + 1])
        predict = predictArray[0]
        # print("预测下标为 : \n", predict)
        # -fixme : get y_pred
        predict = correct(predict)
    ...
    if model_i == 5:
        # 查看是否和y对应位置匹配,X_test对应训练结果是X的位置，对应了y_test
        predictArray = rbf.test(X1_test[i:i + 1])
        predict = predictArray[0]
        # print("预测下标为 : \n", predict)
        # -fixme : get y_pred
        predict = correct(predict)
    ...
    if model_i == 6:
        # 查看是否和y对应位置匹配,X_test对应训练结果是X的位置，对应了y_test
        predictArray = gbr.test(X1_test[i:i + 1])
        predict = predictArray[0]
        # print("预测下标为 : \n", predict)
        # -fixme : get y_pred
        predict = correct(predict)
    ...
    if model_i == 7:
        # 查看是否和y对应位置匹配,X_test对应训练结果是X的位置，对应了y_test
        predictArray = etr.test(X1_test[i:i + 1])
        predict = predictArray[0]
        # print("预测下标为 : \n", predict)
        # -fixme : get y_pred
        predict = correct(predict)
    ...
    if model_i == 8:
        # 查看是否和y对应位置匹配,X_test对应训练结果是X的位置，对应了y_test
        predictArray = linear.test(X1_test[i:i + 1])
        predict = predictArray[0]
        # print("预测下标为 : \n", predict)
        # -fixme : get y_pred
        predict = correct(predict)
    ...
    if error > 0:
        # 在searchArea范围内，遍历
        for pos in range(predict - searchArea, predict + searchArea):
    ...
    # if searchArea > 0:
    #     print("searchArea > 0 ! Need repair")
