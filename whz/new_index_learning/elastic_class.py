...
class elastic_reg:
    ...
    def getscore(self):
        ...
        # store
        joblib.dump(elastic, r'E:\whz\new_index_learning\software_newspaper\trainedModel\elastic.pkl',compress=3)

        y_pred = elastic.predict(X_test)  # 对测试集的预测
    ...
    def test(self, testSet):
        elastic = joblib.load(r'E:\whz\new_index_learning\software_newspaper\trainedModel\elastic.pkl')
        test_predict = elastic.predict(testSet)
        # print(test_predict)
        return test_predict
    ...
    def testWithTime(self, testSet):
        start = time.time_ns()
        etr = joblib.load(r'E:\whz\new_index_learning\software_newspaper\trainedModel\elastic.pkl.pkl')
        end = time.time_ns()
        ioTime = end - start
